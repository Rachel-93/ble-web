        ...
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
                ...
                <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
                    ...
                    <div class="flex mb-10 items-center">
                        <div class="p-2"
                            style="background: #111a3e; width: 50px;height: 46px; display: flex;justify-content: center; border-radius: 50%;
                        overflow: hidden;border: 1px solid#111a3e;backdrop-filter: blur(9px);-webkit-backdrop-filter: blur(9px);">
                            <img src="https://img.icons8.com/ios-filled/50/ffffff/address.png" alt="address" class="w-6">
                        </div>
                        <div class="ml-5 text-white">
                            <h4>Address</h4>
                            <p>No. 10-2, Jalan BPP 5/4, Pusat Bandar Putra Permai,
                                43300 Seri Kembangan, Selangor Darul Ehsan, Malaysia</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form @submit.prevent="sendEmail" class="flex flex-col p-2" data-aos="zoom-in-up" >
                <div class="mb-6">
                    ...
                    <input v-model="email.from" type="email" id="email" class="bg-[#111827] placeholder:[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
                    placeholder="email@gmail.com" name="email">
                </div>
                <div class="mb-6">
                    <label for="subject" class="text-white block mb-2 text-sm font-medium">Subject</label>
                    <input v-model="email.subject" type="subject" id="subject" class="bg-[#111827] placeholder:[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
                    placeholder="subject" name="subject">
                </div>
                <div class="mb-6">
                    <label for="message" class="text-white block mb-2 text-sm font-medium">Message</label>
                    <textarea v-model="email.text" id="Message" class="bg-[#111827] placeholder:[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
                ...
                <p class="italic" v-if="message">{{ message }}</p>
            </form>
        </div>
